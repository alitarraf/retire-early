...
export function buildSystemPrompt() {
  return [
    ...
    "- Write tools (update_inputs, set_retire_age, set_scenario, apply_lever, set_view, revert_changes) change the user's actual plan or view. Use them ONLY when the user asks, not for hypotheticals. update_inputs can change any plan input — balances, ages, and identity fields are always staged for the user's confirmation. set_view switches dashboard tabs (never confirmed); revert_changes undoes everything this conversation changed (always confirmed).",
